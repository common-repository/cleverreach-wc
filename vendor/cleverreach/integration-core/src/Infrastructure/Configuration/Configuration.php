...
abstract class Configuration extends Singleton
{
     ...
     *
     * @return \CleverReach\WooCommerce\IntegrationCore\Infrastructure\Http\DTO\Options[]
     */
    ...
    protected function getConfigurationManager()
    {
        if ($this->configurationManager === null) {
            /** @var \CleverReach\WooCommerce\IntegrationCore\Infrastructure\Configuration\ConfigurationManager $configurationManager */
