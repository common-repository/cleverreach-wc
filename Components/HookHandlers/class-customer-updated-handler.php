...
/**
 * Class Customer_Updated_Handler
 *
 * @package CleverReach\WooCommerce\Components\HookHandlers
 */
class Customer_Updated_Handler extends Base_Handler {
	...
	public function handle( $user_id, $old_user_data ) {
		...
		Logger::logInfo( 'User updated event detected. User id: ' . $user_id, 'Integration' );
